...
import logoImg from '../assets/logo.png'; // 👈 ඔයාගේ කලින් Logo එක
import heroImg from '../assets/driving_hero.png'; // 👈 අලුතින් දාපු Driving Image එක
...
const LandingPage = () => {
    ...
    // Default Branches (Static data used if API fails)
    const defaultBranches = [
        {
            _id: '1',
            name: 'Ogodapola Branch',
            location: 'Ogodapola',
            phones: [{ display: '0761322844', raw: '0761322844' }],
        ...
        },
        {
            ...
            location: 'Weliweriya',
            phones: [{ display: '0773933259', raw: '0773933259' }],
    ...
    return (
        <div style={{ fontFamily: 'Segoe UI, Tahoma, Geneva, Verdana, sans-serif', backgroundColor: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column', color: '#1e293b', margin: 0, padding: 0 }}>

            {/* TOP NAVBAR */}
            <nav style={{ backgroundColor: '#0f172a', color: '#ffffff', padding: '12px 30px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)', position: 'sticky', top: 0, zIndex: 1000 }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <img
                            src={logoImg}
                            alt="New Paradise Learners Logo"
            ...
            <main style={{ maxWidth: '1200px', width: '100%', margin: '0 auto', padding: '40px 20px', boxSizing: 'border-box', flexGrow: 1 }}>
                ...
                */}
                <div style={{ backgroundColor: '#ffffff', borderRadius: '16px', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.08)', overflow: 'hidden', display: 'flex', flexWrap: 'wrap', marginBottom: '40px', border: '1px solid #e2e8f0' }}>
                    ...
                    {/* Left Text Column */}
                    <div style={{ flex: '1 1 500px', padding: '50px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <span style={{ fontSize: '12px', fontWeight: 'bold', color: '#dc2626', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '10px' }}>
                            Premier Driving School System
                        </span>
                        <h2 style={{ fontSize: '36px', fontWeight: '800', color: '#0f172a', margin: '0 0 18px 0', lineHeight: '1.2' }}>
                            Welcome to <br />
                            <span style={{ color: '#1d4ed8' }}>New Paradise Learners</span>
                        </h2>
                        <p style={{ color: '#64748b', fontSize: '16px', lineHeight: '1.6', margin: '0 0 32px 0', maxWidth: '550px' }}>
                        ...
                        {!isAuthenticated && (
                            <div>
                                <Link to="/register" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#dc2626', color: '#ffffff', padding: '14px 30px', borderRadius: '10px', fontWeight: 'bold', textDecoration: 'none', boxShadow: '0 4px 12px rgba(220,38,38,0.25)', gap: '10px', transition: 'all 0.2s' }}
                    ...
                    <div style={{ flex: '1 1 400px', background: 'linear-gradient(135deg, #1e3a8a 0%, #0f172a 100%)', padding: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: '#ffffff' }}>

                        {/* 👈 UPDATED: අලුත් Driving Image එක */}
                        <img
                            src={heroImg}
                            alt="Confidence to Driving"
                            style={{
                                width: '100%',
                                maxWidth: '380px',
                                height: 'auto',
                        ...
                        <h3 style={{ fontSize: '22px', fontWeight: 'bold', margin: '0 0 10px 0', color: '#ffffff' }}>Ready to Start Your Journey?</h3>
                        <p style={{ color: '#bfdbfe', fontSize: '15px', maxWidth: '320px', margin: 0, lineHeight: '1.5' }}>
                                                ...
                                                {branch.phones && branch.phones.length > 0 ? (
                                                    branch.phones.map((p, idx) => (
                                                        <React.Fragment key={idx}>
                                                            <a href={`tel:${p.raw}`} style={{ color: '#1d4ed8', fontWeight: '600', textDecoration: 'none' }}>
                                                                {p.display}
                                                            </a>
            ...
            {/* FOOTER */}
            <footer style={{ backgroundColor: '#0f172a', color: '#94a3b8', fontSize: '12px', padding: '20px 0', textAlign: 'center', borderTop: '1px solid #1e293b', marginTop: '40px' }}>
